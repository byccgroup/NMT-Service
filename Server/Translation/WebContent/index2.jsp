...
<body>
	...
	<div id="main" style="width:80%; float:left">
		...
		<div style="height:250px; width:100%; background-color:#FFCCFF">
			<!-- 输入文本域  -->
			<div id="left_text" style="width:50%; float:left;" >
				<textarea id="inputtext" name="inputtext" style="background-color:#E0E0E0; margin-bottom:3px; width:100%; height:25%; float:left"></textarea>
				<script>
			...
			<!-- 输出文本域  -->
			<div id="right_text" style="width:50%; float:left">
				<textarea id="result"  style="background-color:#E0E0E0;  margin-bottom:3px; width:100%; height:25%; float:left"></textarea>
				<script>
